  ...
  return (
    <>
      ...
      <main className="auth-wrap" style={{
        ...
        <Card className="auth-card" style={{ display: 'grid', gap: 14 }}>
          <h1 className="h1 accent" style={{ marginBottom: 4 }}>Verify your phone</h1>
          ...
          {phase === 'collect' && (
            <form onSubmit={sendCode} style={{ display: 'grid', gap: 12 }}>
              <Input
                ...
                required
              />
              <label className="hint" style={{ display: 'flex', gap: 8, alignItems: 'center', fontSize: 13 }}>
                <input
                  type="checkbox"
                  checked={consent}
