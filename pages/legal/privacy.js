      ...
      >
        <Card className="auth-card" style={{ maxWidth: 900 }}>
          ...
          <div style={{ display: "grid", gap: 16, fontSize: 15, lineHeight: 1.6 }}>
            <p>
              TurnQA is a workflow tool for property managers and cleaners. This Privacy Policy
              explains what information we collect, how we use it, and the choices you have.
            </p>

            <h2 className="h2">Information We Collect</h2>
            <ul style={{ paddingLeft: 20 }}>
              <li><strong>Account information</strong> – name, email, business details you provide.</li>
              <li><strong>Property & job data</strong> – names, checklists, photos, job status.</li>
              <li><strong>Contact information</strong> – phone numbers for transactional SMS.</li>
              <li><strong>Usage information</strong> – logs of access dates & device details.</li>
            </ul>

            <h2 className="h2">How We Use Information</h2>
            <ul style={{ paddingLeft: 20 }}>
              <li>Operate and improve the TurnQA service.</li>
              <li>Send transactional job-related notifications (submitted / approved).</li>
            ...
            <p>
              Email: <a href="mailto:support@turnqa.com">support@turnqa.com</a>
            </p>
          </div>
        </Card>
      </main>
